...
<v-toolbar app fixed clipped-left color="primary" dark>
  ...
  <router-link class="link mr-3 black--text ml-3 hidden-xs-only" to="/">Товары</router-link>
  <router-link class="link mr-3 black--text hidden-xs-only" to="/contact">Контакты</router-link>
  <router-link class="link mr-3 black--text hidden-xs-only" to="/about">О нас</router-link>

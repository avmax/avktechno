...
exports.post = (req, res, next) => {
  const body = req.body || { };
  db.query(
    `INSERT INTO categories (name, title, imgUrl) VALUES ('${body.name}', '${body.title}', '${body.imgUrl}');`,
    (err, result) => {
...
exports.put = (req, res, next) => {
  const body = req.body || { };
  db.query(
    `UPDATE categories SET name='${body.name}', title='${body.title}', imgUrl='${body.imgUrl}' WHERE id=${body.id};`,
    (err, result) => {
